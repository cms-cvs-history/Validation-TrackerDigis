...
SiPixelDigiValid::SiPixelDigiValid(const ParameterSet& ps):dbe_(0){
  ...
  /////Barrel 
   meAdcLayer1Ring1_ = dbe_->book1D("adc_layer1ring1","Digi charge",150, 0., 300.);
   meAdcLayer1Ring2_ = dbe_->book1D("adc_layer1ring2","Digi charge",150, 0., 300.);
   meAdcLayer1Ring3_ = dbe_->book1D("adc_layer1ring3","Digi charge",150, 0., 300.);
   meAdcLayer1Ring4_ = dbe_->book1D("adc_layer1ring4","Digi charge",150, 0., 300.);
   meAdcLayer1Ring5_ = dbe_->book1D("adc_layer1ring5","Digi charge",150, 0., 300.);
   meAdcLayer1Ring6_ = dbe_->book1D("adc_layer1ring6","Digi charge",150, 0., 300.);
   meAdcLayer1Ring7_ = dbe_->book1D("adc_layer1ring7","Digi charge",150, 0., 300.);
   meAdcLayer1Ring8_ = dbe_->book1D("adc_layer1ring8","Digi charge",150, 0., 300.);

   meRowLayer1Ring1_ = dbe_->book1D("row_layer1ring1","Digi row",100, 0., 200.);
   meRowLayer1Ring2_ = dbe_->book1D("row_layer1ring2","Digi row",100, 0., 200.);
   meRowLayer1Ring3_ = dbe_->book1D("row_layer1ring3","Digi row",100, 0., 200.);
   meRowLayer1Ring4_ = dbe_->book1D("row_layer1ring4","Digi row",100, 0., 200.);
   meRowLayer1Ring5_ = dbe_->book1D("row_layer1ring5","Digi row",100, 0., 200.);
   meRowLayer1Ring6_ = dbe_->book1D("row_layer1ring6","Digi row",100, 0., 200.);
   meRowLayer1Ring7_ = dbe_->book1D("row_layer1ring7","Digi row",100, 0., 200.);
   meRowLayer1Ring8_ = dbe_->book1D("row_layer1ring8","Digi row",100, 0., 200.);

   meColLayer1Ring1_ = dbe_->book1D("col_layer1ring1","Digi column",250, 0., 500.);
   meColLayer1Ring2_ = dbe_->book1D("col_layer1ring2","Digi column",250, 0., 500.);
   meColLayer1Ring3_ = dbe_->book1D("col_layer1ring3","Digi column",250, 0., 500.);
   meColLayer1Ring4_ = dbe_->book1D("col_layer1ring4","Digi column",250, 0., 500.);
   meColLayer1Ring5_ = dbe_->book1D("col_layer1ring5","Digi column",250, 0., 500.);
   meColLayer1Ring6_ = dbe_->book1D("col_layer1ring6","Digi column",250, 0., 500.);
   meColLayer1Ring7_ = dbe_->book1D("col_layer1ring7","Digi column",250, 0., 500.);
   meColLayer1Ring8_ = dbe_->book1D("col_layer1ring8","Digi column",250, 0., 500.);
   

   meAdcLayer2Ring1_ = dbe_->book1D("adc_layer2ring1","Digi charge",150, 0., 300.);
   meAdcLayer2Ring2_ = dbe_->book1D("adc_layer2ring2","Digi charge",150, 0., 300.);
   meAdcLayer2Ring3_ = dbe_->book1D("adc_layer2ring3","Digi charge",150, 0., 300.);
   meAdcLayer2Ring4_ = dbe_->book1D("adc_layer2ring4","Digi charge",150, 0., 300.);
   meAdcLayer2Ring5_ = dbe_->book1D("adc_layer2ring5","Digi charge",150, 0., 300.);
   meAdcLayer2Ring6_ = dbe_->book1D("adc_layer2ring6","Digi charge",150, 0., 300.);
   meAdcLayer2Ring7_ = dbe_->book1D("adc_layer2ring7","Digi charge",150, 0., 300.);
   meAdcLayer2Ring8_ = dbe_->book1D("adc_layer2ring8","Digi charge",150, 0., 300.);

   meRowLayer2Ring1_ = dbe_->book1D("row_layer2ring1","Digi row",100, 0., 200.);
   meRowLayer2Ring2_ = dbe_->book1D("row_layer2ring2","Digi row",100, 0., 200.);
   meRowLayer2Ring3_ = dbe_->book1D("row_layer2ring3","Digi row",100, 0., 200.);
   meRowLayer2Ring4_ = dbe_->book1D("row_layer2ring4","Digi row",100, 0., 200.);
   meRowLayer2Ring5_ = dbe_->book1D("row_layer2ring5","Digi row",100, 0., 200.);
   meRowLayer2Ring6_ = dbe_->book1D("row_layer2ring6","Digi row",100, 0., 200.);
   meRowLayer2Ring7_ = dbe_->book1D("row_layer2ring7","Digi row",100, 0., 200.);
   meRowLayer2Ring8_ = dbe_->book1D("row_layer2ring8","Digi row",100, 0., 200.);

   meColLayer2Ring1_ = dbe_->book1D("col_layer2ring1","Digi column",250, 0., 500.);
   meColLayer2Ring2_ = dbe_->book1D("col_layer2ring2","Digi column",250, 0., 500.);
   meColLayer2Ring3_ = dbe_->book1D("col_layer2ring3","Digi column",250, 0., 500.);
   meColLayer2Ring4_ = dbe_->book1D("col_layer2ring4","Digi column",250, 0., 500.);
   meColLayer2Ring5_ = dbe_->book1D("col_layer2ring5","Digi column",250, 0., 500.);
   meColLayer2Ring6_ = dbe_->book1D("col_layer2ring6","Digi column",250, 0., 500.);
   meColLayer2Ring7_ = dbe_->book1D("col_layer2ring7","Digi column",250, 0., 500.);
   meColLayer2Ring8_ = dbe_->book1D("col_layer2ring8","Digi column",250, 0., 500.);


   meAdcLayer3Ring1_ = dbe_->book1D("adc_layer3ring1","Digi charge",150, 0., 300.);
   meAdcLayer3Ring2_ = dbe_->book1D("adc_layer3ring2","Digi charge",150, 0., 300.);
   meAdcLayer3Ring3_ = dbe_->book1D("adc_layer3ring3","Digi charge",150, 0., 300.);
   meAdcLayer3Ring4_ = dbe_->book1D("adc_layer3ring4","Digi charge",150, 0., 300.);
   meAdcLayer3Ring5_ = dbe_->book1D("adc_layer3ring5","Digi charge",150, 0., 300.);
   meAdcLayer3Ring6_ = dbe_->book1D("adc_layer3ring6","Digi charge",150, 0., 300.);
   meAdcLayer3Ring7_ = dbe_->book1D("adc_layer3ring7","Digi charge",150, 0., 300.);
   meAdcLayer3Ring8_ = dbe_->book1D("adc_layer3ring8","Digi charge",150, 0., 300.);

   meRowLayer3Ring1_ = dbe_->book1D("row_layer3ring1","Digi row",100, 0., 200.);
   meRowLayer3Ring2_ = dbe_->book1D("row_layer3ring2","Digi row",100, 0., 200.);
   meRowLayer3Ring3_ = dbe_->book1D("row_layer3ring3","Digi row",100, 0., 200.);
   meRowLayer3Ring4_ = dbe_->book1D("row_layer3ring4","Digi row",100, 0., 200.);
   meRowLayer3Ring5_ = dbe_->book1D("row_layer3ring5","Digi row",100, 0., 200.);
   meRowLayer3Ring6_ = dbe_->book1D("row_layer3ring6","Digi row",100, 0., 200.);
   meRowLayer3Ring7_ = dbe_->book1D("row_layer3ring7","Digi row",100, 0., 200.);
   meRowLayer3Ring8_ = dbe_->book1D("row_layer3ring8","Digi row",100, 0., 200.);

   meColLayer3Ring1_ = dbe_->book1D("col_layer3ring1","Digi column",250, 0., 500.);
   meColLayer3Ring2_ = dbe_->book1D("col_layer3ring2","Digi column",250, 0., 500.);
   meColLayer3Ring3_ = dbe_->book1D("col_layer3ring3","Digi column",250, 0., 500.);
   meColLayer3Ring4_ = dbe_->book1D("col_layer3ring4","Digi column",250, 0., 500.);
   meColLayer3Ring5_ = dbe_->book1D("col_layer3ring5","Digi column",250, 0., 500.);
   meColLayer3Ring6_ = dbe_->book1D("col_layer3ring6","Digi column",250, 0., 500.);
   meColLayer3Ring7_ = dbe_->book1D("col_layer3ring7","Digi column",250, 0., 500.);
   meColLayer3Ring8_ = dbe_->book1D("col_layer3ring8","Digi column",250, 0., 500.);

 //Forward Pixel
   /* ZMinus Side 1st Disk */
   meAdcZmDisk1Panel1Plaq1_ = dbe_->book1D("adc_zm_disk1_panel1_plaq1","Digi charge",150,0.,300.);
   meAdcZmDisk1Panel1Plaq2_ = dbe_->book1D("adc_zm_disk1_panel1_plaq2","Digi charge",150,0.,300.);
   meAdcZmDisk1Panel1Plaq3_ = dbe_->book1D("adc_zm_disk1_panel1_plaq3","Digi charge",150,0.,300.);
   meAdcZmDisk1Panel1Plaq4_ = dbe_->book1D("adc_zm_disk1_panel1_plaq4","Digi charge",150,0.,300.);
   meAdcZmDisk1Panel2Plaq1_ = dbe_->book1D("adc_zm_disk1_panel2_plaq1","Digi charge",150,0.,300.);
   meAdcZmDisk1Panel2Plaq2_ = dbe_->book1D("adc_zm_disk1_panel2_plaq2","Digi charge",150,0.,300.);
   meAdcZmDisk1Panel2Plaq3_ = dbe_->book1D("adc_zm_disk1_panel2_plaq3","Digi charge",150,0.,300.);

   meRowZmDisk1Panel1Plaq1_ = dbe_->book1D("row_zm_disk1_panel1_plaq1","Digi row",100,0.,200.);
   meRowZmDisk1Panel1Plaq2_ = dbe_->book1D("row_zm_disk1_panel1_plaq2","Digi row",100,0.,200.);
   meRowZmDisk1Panel1Plaq3_ = dbe_->book1D("row_zm_disk1_panel1_plaq3","Digi row",100,0.,200.);
   meRowZmDisk1Panel1Plaq4_ = dbe_->book1D("row_zm_disk1_panel1_plaq4","Digi row",100,0.,200.);
   meRowZmDisk1Panel2Plaq1_ = dbe_->book1D("row_zm_disk1_panel2_plaq1","Digi row",100,0.,200.);
   meRowZmDisk1Panel2Plaq2_ = dbe_->book1D("row_zm_disk1_panel2_plaq2","Digi row",100,0.,200.);
   meRowZmDisk1Panel2Plaq3_ = dbe_->book1D("row_zm_disk1_panel2_plaq3","Digi row",100,0.,200.);

   meColZmDisk1Panel1Plaq1_ = dbe_->book1D("col_zm_disk1_panel1_plaq1","Digi column",250,0.,500.);
   meColZmDisk1Panel1Plaq2_ = dbe_->book1D("col_zm_disk1_panel1_plaq2","Digi column",250,0.,500.);
   meColZmDisk1Panel1Plaq3_ = dbe_->book1D("col_zm_disk1_panel1_plaq3","Digi column",250,0.,500.);
   meColZmDisk1Panel1Plaq4_ = dbe_->book1D("col_zm_disk1_panel1_plaq4","Digi column",250,0.,500.);
   meColZmDisk1Panel2Plaq1_ = dbe_->book1D("col_zm_disk1_panel2_plaq1","Digi column",250,0.,500.);
   meColZmDisk1Panel2Plaq2_ = dbe_->book1D("col_zm_disk1_panel2_plaq2","Digi column",250,0.,500.);
   meColZmDisk1Panel2Plaq3_ = dbe_->book1D("col_zm_disk1_panel2_plaq3","Digi column",250,0.,500.);
   ...
   /* ZMius Side 2nd disk */
   meAdcZmDisk2Panel1Plaq1_ = dbe_->book1D("adc_zm_disk2_panel1_plaq1","Digi charge",150,0.,300.);
   meAdcZmDisk2Panel1Plaq2_ = dbe_->book1D("adc_zm_disk2_panel1_plaq2","Digi charge",150,0.,300.);
   meAdcZmDisk2Panel1Plaq3_ = dbe_->book1D("adc_zm_disk2_panel1_plaq3","Digi charge",150,0.,300.);
   meAdcZmDisk2Panel1Plaq4_ = dbe_->book1D("adc_zm_disk2_panel1_plaq4","Digi charge",150,0.,300.);
   meAdcZmDisk2Panel2Plaq1_ = dbe_->book1D("adc_zm_disk2_panel2_plaq1","Digi charge",150,0.,300.);
   meAdcZmDisk2Panel2Plaq2_ = dbe_->book1D("adc_zm_disk2_panel2_plaq2","Digi charge",150,0.,300.);
   meAdcZmDisk2Panel2Plaq3_ = dbe_->book1D("adc_zm_disk2_panel2_plaq3","Digi charge",150,0.,300.);

   meRowZmDisk2Panel1Plaq1_ = dbe_->book1D("row_zm_disk2_panel1_plaq1","Digi row",100,0.,200.);
   meRowZmDisk2Panel1Plaq2_ = dbe_->book1D("row_zm_disk2_panel1_plaq2","Digi row",100,0.,200.);
   meRowZmDisk2Panel1Plaq3_ = dbe_->book1D("row_zm_disk2_panel1_plaq3","Digi row",100,0.,200.);
   meRowZmDisk2Panel1Plaq4_ = dbe_->book1D("row_zm_disk2_panel1_plaq4","Digi row",100,0.,200.);
   meRowZmDisk2Panel2Plaq1_ = dbe_->book1D("row_zm_disk2_panel2_plaq1","Digi row",100,0.,200.);
   meRowZmDisk2Panel2Plaq2_ = dbe_->book1D("row_zm_disk2_panel2_plaq2","Digi row",100,0.,200.);
   meRowZmDisk2Panel2Plaq3_ = dbe_->book1D("row_zm_disk2_panel2_plaq3","Digi row",100,0.,200.);

   meColZmDisk2Panel1Plaq1_ = dbe_->book1D("col_zm_disk2_panel1_plaq1","Digi Column",250,0.,500.);
   meColZmDisk2Panel1Plaq2_ = dbe_->book1D("col_zm_disk2_panel1_plaq2","Digi Column",250,0.,500.);
   meColZmDisk2Panel1Plaq3_ = dbe_->book1D("col_zm_disk2_panel1_plaq3","Digi Column",250,0.,500.);
   meColZmDisk2Panel1Plaq4_ = dbe_->book1D("col_zm_disk2_panel1_plaq4","Digi Column",250,0.,500.);
   meColZmDisk2Panel2Plaq1_ = dbe_->book1D("col_zm_disk2_panel2_plaq1","Digi Column",250,0.,500.);
   meColZmDisk2Panel2Plaq2_ = dbe_->book1D("col_zm_disk2_panel2_plaq2","Digi Column",250,0.,500.);
   meColZmDisk2Panel2Plaq3_ = dbe_->book1D("col_zm_disk2_panel2_plaq3","Digi Column",250,0.,500.);
   ...
   /* ZPlus Side 1st Disk */
   meAdcZpDisk1Panel1Plaq1_ = dbe_->book1D("adc_zp_disk1_panel1_plaq1","Digi charge",150,0.,300.);
   meAdcZpDisk1Panel1Plaq2_ = dbe_->book1D("adc_zp_disk1_panel1_plaq2","Digi charge",150,0.,300.);
   meAdcZpDisk1Panel1Plaq3_ = dbe_->book1D("adc_zp_disk1_panel1_plaq3","Digi charge",150,0.,300.);
   meAdcZpDisk1Panel1Plaq4_ = dbe_->book1D("adc_zp_disk1_panel1_plaq4","Digi charge",150,0.,300.);
   meAdcZpDisk1Panel2Plaq1_ = dbe_->book1D("adc_zp_disk1_panel2_plaq1","Digi charge",150,0.,300.);
   meAdcZpDisk1Panel2Plaq2_ = dbe_->book1D("adc_zp_disk1_panel2_plaq2","Digi charge",150,0.,300.);
   meAdcZpDisk1Panel2Plaq3_ = dbe_->book1D("adc_zp_disk1_panel2_plaq3","Digi charge",150,0.,300.);

   meRowZpDisk1Panel1Plaq1_ = dbe_->book1D("row_zp_disk1_panel1_plaq1","Digi row",100,0.,200.);
   meRowZpDisk1Panel1Plaq2_ = dbe_->book1D("row_zp_disk1_panel1_plaq2","Digi row",100,0.,200.);
   meRowZpDisk1Panel1Plaq3_ = dbe_->book1D("row_zp_disk1_panel1_plaq3","Digi row",100,0.,200.);
   meRowZpDisk1Panel1Plaq4_ = dbe_->book1D("row_zp_disk1_panel1_plaq4","Digi row",100,0.,200.);
   meRowZpDisk1Panel2Plaq1_ = dbe_->book1D("row_zp_disk1_panel2_plaq1","Digi row",100,0.,200.);
   meRowZpDisk1Panel2Plaq2_ = dbe_->book1D("row_zp_disk1_panel2_plaq2","Digi row",100,0.,200.);
   meRowZpDisk1Panel2Plaq3_ = dbe_->book1D("row_zp_disk1_panel2_plaq3","Digi row",100,0.,200.);

   meColZpDisk1Panel1Plaq1_ = dbe_->book1D("col_zp_disk1_panel1_plaq1","Digi Column",250,0.,500.);
   meColZpDisk1Panel1Plaq2_ = dbe_->book1D("col_zp_disk1_panel1_plaq2","Digi column",250,0.,500.);
   meColZpDisk1Panel1Plaq3_ = dbe_->book1D("col_zp_disk1_panel1_plaq3","Digi column",250,0.,500.);
   meColZpDisk1Panel1Plaq4_ = dbe_->book1D("col_zp_disk1_panel1_plaq4","Digi column",250,0.,500.);
   meColZpDisk1Panel2Plaq1_ = dbe_->book1D("col_zp_disk1_panel2_plaq1","Digi column",250,0.,500.);
   meColZpDisk1Panel2Plaq2_ = dbe_->book1D("col_zp_disk1_panel2_plaq2","Digi column",250,0.,500.);
   meColZpDisk1Panel2Plaq3_ = dbe_->book1D("col_zp_disk1_panel2_plaq3","Digi column",250,0.,500.);
   ...
   /* ZPlus Side 2nd disk */
   meAdcZpDisk2Panel1Plaq1_ = dbe_->book1D("adc_zp_disk2_panel1_plaq1","Digi charge",150,0.,300.);
   meAdcZpDisk2Panel1Plaq2_ = dbe_->book1D("adc_zp_disk2_panel1_plaq2","Digi charge",150,0.,300.);
   meAdcZpDisk2Panel1Plaq3_ = dbe_->book1D("adc_zp_disk2_panel1_plaq3","Digi charge",150,0.,300.);
   meAdcZpDisk2Panel1Plaq4_ = dbe_->book1D("adc_zp_disk2_panel1_plaq4","Digi charge",150,0.,300.);
   meAdcZpDisk2Panel2Plaq1_ = dbe_->book1D("adc_zp_disk2_panel2_plaq1","Digi charge",150,0.,300.);
   meAdcZpDisk2Panel2Plaq2_ = dbe_->book1D("adc_zp_disk2_panel2_plaq2","Digi charge",150,0.,300.);
   meAdcZpDisk2Panel2Plaq3_ = dbe_->book1D("adc_zp_disk2_panel2_plaq3","Digi charge",150,0.,300.);

   meRowZpDisk2Panel1Plaq1_ = dbe_->book1D("row_zp_disk2_panel1_plaq1","Digi row",100,0.,200.);
   meRowZpDisk2Panel1Plaq2_ = dbe_->book1D("row_zp_disk2_panel1_plaq2","Digi row",100,0.,200.);
   meRowZpDisk2Panel1Plaq3_ = dbe_->book1D("row_zp_disk2_panel1_plaq3","Digi row",100,0.,200.);
   meRowZpDisk2Panel1Plaq4_ = dbe_->book1D("row_zp_disk2_panel1_plaq4","Digi row",100,0.,200.);
   meRowZpDisk2Panel2Plaq1_ = dbe_->book1D("row_zp_disk2_panel2_plaq1","Digi row",100,0.,200.);
   meRowZpDisk2Panel2Plaq2_ = dbe_->book1D("row_zp_disk2_panel2_plaq2","Digi row",100,0.,200.);
   meRowZpDisk2Panel2Plaq3_ = dbe_->book1D("row_zp_disk2_panel2_plaq3","Digi row",100,0.,200.);

   meColZpDisk2Panel1Plaq1_ = dbe_->book1D("col_zp_disk2_panel1_plaq1","Digi column",250,0.,500.);
   meColZpDisk2Panel1Plaq2_ = dbe_->book1D("col_zp_disk2_panel1_plaq2","Digi column",250,0.,500.);
   meColZpDisk2Panel1Plaq3_ = dbe_->book1D("col_zp_disk2_panel1_plaq3","Digi column",250,0.,500.);
   meColZpDisk2Panel1Plaq4_ = dbe_->book1D("col_zp_disk2_panel1_plaq4","Digi column",250,0.,500.);
   meColZpDisk2Panel2Plaq1_ = dbe_->book1D("col_zp_disk2_panel2_plaq1","Digi column",250,0.,500.);
   meColZpDisk2Panel2Plaq2_ = dbe_->book1D("col_zp_disk2_panel2_plaq2","Digi column",250,0.,500.);
   meColZpDisk2Panel2Plaq3_ = dbe_->book1D("col_zp_disk2_panel2_plaq3","Digi column",250,0.,500.);
